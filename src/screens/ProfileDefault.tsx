          ...
          {isMine ? (
            <>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 4, paddingHorizontal: 20, paddingTop: 10 }}>
                {HOTS.map((h) => (
                  <Pressable key={h.label} onPress={() => { if (h.targetFlow === "chats") router.push("/chats"); else if (h.targetFlow === "activity") router.push("/activity"); else soon(h.label, h.targetFlow); }} style={{ width: 77, height: 64, borderRadius: 24, backgroundColor: "rgba(255,255,255,0.05)", alignItems: "center", justifyContent: "center", gap: 2 }}>
